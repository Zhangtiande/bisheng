...
import { BookOpenTextIcon, Bot, Brain, Code2, FileDown, FileSearch, FlagTriangleRight, Hammer, Home, Keyboard, MessagesSquareIcon, Split, HelpCircle, Lightbulb } from "lucide-react";
export const Icons = {
    'start': Home,
    'input': Keyboard,
